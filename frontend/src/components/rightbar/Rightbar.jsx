...
export default function Rightbar() {
  ...
  async function getTalked() {
    try {
      const res = await fetch(
        `${process.env.REACT_APP_BACKEND_URL}/api/message/getTalked/${user.id}`,
        {
          credentials: "include",
        }
      );
  ...
  async function getMessages(talkingUser) {
    ...
    try {
      const res = await fetch(
        `${process.env.REACT_APP_BACKEND_URL}/api/message/getMessages/${user.id}`,
        {
          method: "post",
          credentials: "include",
  ...
  async function sendMessage() {
    try {
      const res = await fetch(
        `${process.env.REACT_APP_BACKEND_URL}/api/message/create/${user.id}`,
        {
          method: "post",
          credentials: "include",
          body: JSON.stringify({
